...
import nasim
from nasim.agents.attacker.dueling_dqn_agent import DuelingDQNAgent

if __name__ == "__main__":

    env = nasim.make_benchmark('tiny-etri-alpinelab',fully_obs=True, flat_actions=True, flat_obs=True)

    dqn_agent_attacker = DuelingDQNAgent(env, lr=0.001, training_steps=2000000, batch_size=32, replay_size=10000, final_epsilon=0.05,
