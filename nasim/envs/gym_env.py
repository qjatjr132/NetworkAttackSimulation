...
class NASimGymEnv(NASimEnv):
    ...
    See nasim_with_defender.NASimEnv for details.
    """
    ...
    def __init__(self,
        ...
        Parameters
        ----------
        scenario : str or or nasim_with_defender.scenarios.Scenario
            either the name of benchmark environment (str) or a nasim_with_defender Scenario
            instance
